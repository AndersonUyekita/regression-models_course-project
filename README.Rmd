...
I have decided to use a simpler model due to the parsimony. The `R² adjusted` has reached `r round(summary(fit_final)$adj.r.squared,4)*100`%. All p-values of the model are below alpha (5%).
